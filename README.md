...
├── R/mod_temporada.R     # pestaña «Temporada anual»
...
1. **Temporada anual**: segmentos inicio–fin por año de fuego, un índice a
   elegir en barras, la tabla y su descarga.
2. Celdas, áreas de conservación, comparación, ENSO y fuentes estáticas: en
   construcción, en ese orden.
