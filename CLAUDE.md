...
- Orden previsto en el mismo mapa: coropleta por AC → acuerdo entre
  plataformas → fuentes estáticas; luego vistas anuales y ENSO; al final
  renv.lock y despliegue a shinyapps.io (cuenta incendios-forestales).
